function [circle,error] = ISOCENTER_CONE(path)
%% 
...
for i = 1:size(file,1)
    ...
    lower_rad = int16(radiis-5); upper_rad = int16(radiis+5);
    ...
    %% calculate errors
    circle(i,:) = {[i,center_in,radius_in,centersb,radiib]};
    ...
    hold on;
    plot(center_in(1)-349,center_in(2)-349,'b+','LineWidth',1);
    hold on;
    plot(centersb(1)-349,centersb(2)-349,'g+','LineWidth',1);
    hold on;
    viscircles(center_in-349, radius_in,'Color','b','LineWidth',1);
    hold on;
