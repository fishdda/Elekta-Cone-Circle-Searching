...
# def Open():
# 	global filename
# 	filename =  filedialog.askopenfilenames(initialdir = "C:/",
# 	    title = "Select file",filetypes = (("DICOM files","*.dcm"),("HIS files","*.his"),("all files","*.*")))
# 	print (filename)  # tuple

# filename =['C:\\Users\\EXTHuaXia\\Desktop\\BBfinder\\Cone\\1.his',
# 			'C:\\Users\\EXTHuaXia\\Desktop\\BBfinder\\Cone\\2.his',
# 			'C:\\Users\\EXTHuaXia\\Desktop\\BBfinder\\Cone\\3.his',
# 			'C:\\Users\\EXTHuaXia\\Desktop\\BBfinder\\Cone\\4.his']
# ## Read the image files
# img = BB.Read_File(filename)

# ## Enter information ##
# RS,IR,OR = BB.Enter_Inf()

# ## Finding the IsoCenter ##
# test_img,cir_in,cir_out,cir_error = BB.Find_Circles(img,IR,OR,RS)

# ## Calculation of Modification ##
# D,SD = BB.Modify_Cal(cir_error)

# ## Plot the Image ##
# f = BB.Plot(test_img,cir_in,cir_out,cir_error)
...
class PageOne(tk.Frame):
	...
	def __init__(self,parent,controller):
		...
		tk.Frame.__init__(self,parent)
		label = tk.Label(self,text="Error Analysis",font = LARGE_FONT)
		label.pack(pady = 10,padx = 10)
